    ...
    <div className="min-h-screen bg-muted/30">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <Card
            className="border-status-ok bg-status-ok-bg/50 cursor-pointer"
            onClick={() =>
          ...
          >
           ...
           <Card
            className="border-status-warning bg-status-warning-bg/50 cursor-pointer"
            onClick={() =>
          ...
          >
            ...
            <CardContent>
              <p className="text-3xl font-bold text-status-warning-foreground">{alerts.warning}</p>
              <p className="text-xs text-muted-foreground mt-1">7 días o menos</p>
            </CardContent>
          </Card>
          
          <Card
            className="border-status-critical bg-status-critical-bg/50 cursor-pointer"
            onClick={() =>
              navigate("/alerts", { state: { locationId: selectedLocation } })
            }
          >
            ...
            <CardContent>
              <p className="text-3xl font-bold text-status-critical">{alerts.critical}</p>
              <p className="text-xs text-muted-foreground mt-1">3 días o menos</p>
            </CardContent>
          </Card>
          
           <Card className="cursor-pointer" onClick={() => navigate("/inventory", { state: { locationId: selectedLocation } })}>
            <CardHeader className="pb-3">
